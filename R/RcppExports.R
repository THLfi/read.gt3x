...
activityAsDataFrame <- function(m, time_index, start_time, sample_rate) {
    .Call('_read_gt3x_activityAsDataFrame', PACKAGE = 'read.gt3x', m, time_index, start_time, sample_rate)
}
