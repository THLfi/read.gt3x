...
[![AppVeyorBuild status](https://ci.appveyor.com/api/projects/status/reoqj8ber20dnsmm/branch/master?svg=true)](https://ci.appveyor.com/project/muschellij2/read-gt3x/branch/master)
[![R build status](https://github.com/THLfi/read.gt3x/workflows/R-CMD-check/badge.svg)](https://github.com/THLfi/read.gt3x/actions)
<!-- badges: end -->
